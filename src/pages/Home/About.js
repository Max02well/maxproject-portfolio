        ...
        <div>
            ...
            <div className='flex w-full gap-10 items-center sm:flex-col'>
                <div className='w-1/2 justify-center h-[70vh] sm:w-full'>
                    <img src={logo} alt='my_image' className='w-full h-full max-w-[350px] max-h-[500px] sm:ml-10 ml-20 object-cover rounded-3xl  max-w-md-[200px] transition-transform duration-300 ease-in-out transform hover:scale-105 shadow-lg' loading="lazy" />
                </div>
